...
{
    //From http://www.interact-sw.co.uk/iangblog/2007/12/13/natural-sorting (MIT Licence)
    internal class NaturalSorter
    {
        /// <summary>
        ...
        public static object Convert(string sr)
        {
            try
            {
                return double.Parse(sr);
            }
            catch
            {
                return sr;
    ...
    public static partial class Extensions
    {
        ...
        {
            return list.OrderBy((str) => { return Regex.Split(str.Replace(" ", ""), "([0-9]+)").Select(NaturalSorter.Convert); }, new NaturalSorter.EnumerableComparer<object>());
        }

        public static IEnumerable<System.Reflection.MemberInfo> NaturalSort(this IEnumerable<System.Reflection.MemberInfo> list)
        {
            return list.OrderBy((el) => { return el.Name; });
        }
    }
}
